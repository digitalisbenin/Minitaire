...
<div class=" h-screen">
    <div class="mt-5 " style="margin-left: 6rem; margin-right: 6rem;">
        ...
        <div class="d-flex mx-5">
            ...
            <div class="ms-auto mt-3">
              <div class="d-flex align-items-center border border-secondary rounded-pill bg-white px-3 py-2">
                ...
                />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="bi bi-search" style="width: 24px;">
      ...
      <div class="d-flex mx-5 mt-5">
        <!-- Texte principal -->
        <div>
          <a href="/blogplus" class="text-decoration-none hover text-dark">
            <h1 class="h3 font-monospace">Lorem ipsum dolor, consectetuer</h1>
          </a>
